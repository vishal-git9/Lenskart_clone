...
import { Box, Divider, Flex, Image, Text, Button, useToast } from "@chakra-ui/react";
                  ...
                  <a href="/" rel="noopener noreferrer">
                    <Box>
                      <Text fontWeight='700'
                        ...
                        {/* static data */}
                        {/* {el.title} */}
                        {el.Brands + " " + el.title + ' ' + el.FrameSize + ' ' + el.FrameType}
                      </Text>
                    </Box>
                  </a>
                </Box>
                ...
                <Box>
                  <Flex alignItems='center' gap={2}>
                    ...
                    isDisabled={el.quantity===1}
                      ...
                      onClick={() =>{
                        props.updateminus(el.id,el.quantity-1)
                      }}

                    ><Text ><AiOutlineMinusCircle size={15}/></Text></Button>
                    <Text  >{parseInt(el.quantity)}</Text>
                    <Button bg='white' color='green'
                      ...
                      onClick={() =>{
                        props.update(el.id,el.quantity+1)
                      }}
