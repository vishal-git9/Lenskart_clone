...
import { decreaseQuantity, deleteCartProducts, getCartProducts, increaseQuantity } from '../Redux/Cart/cart.actions';
                ...
                <Box display="flex" flexDirection="column" gap={30}>
                  ...
                  <Box display="flex" gap={6} alignItems="center" bg="#fff" borderRadius='12px' p='6' boxShadow='0 1px 4px rgb(0 0 0 / 10%)'>
                    <Box display='flex' flexDirection='column' w='100%'>
                      ...
                      <Box fontWeight='700'
                        fontSize='16px' lineHeight='24px'><CartPrice priceTitle={"Total payable"} price={apply ? '₹' + (actual() - discount) : '₹' + (actual()+269.82) } />
                        {console.log(apply)}
                      </Box>
